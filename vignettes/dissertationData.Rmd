...
If you haven't installed the package yet, you can install it from CRAN (or GitHub if it's not on CRAN yet):

```{r eval=FALSE}
# Install from CRAN:
# install.packages("dissertationData")
...
The main function you'll use is `get_raw_data()`. This function lets you choose the year and format of the data you want to work with. For example, to load the YRBS data for 2017 (which is available in the package), you simply run:
