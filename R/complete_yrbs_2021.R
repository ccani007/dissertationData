#' Youth Risk Behavior Surveillance System 2021
#'
#' @title complete_yrbs_2021
#'
#' @docType data
#'
#' @usage data(complete_yrbs_2021)
#'
#' @description This is the imported and cleaned 2021 YRBS Data.
...
#'  please consult the documentation in the 2021 National YRBS
