...
#'
#' @title suicide_related_variables
#'
#' @docType data
#'
#'
#' @usage data(suicide_related_variables)
#'
#'
#' @description This dataset comprises 27 variables specifically associated
...
#'   }
#'
#' @format A tibble with 14765 rows and 27 variables:
#'
