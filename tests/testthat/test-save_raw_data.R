...
test_that("save_raw_data validates inputs correctly", {
  # Test invalid year format
  expect_error(
    save_raw_data("not a year"),
  ...
  # Test invalid format
  expect_error(
    save_raw_data(2017, format = "invalid"),
    "should be one of"
  )
})

test_that("save_raw_data handles missing files appropriately", {
